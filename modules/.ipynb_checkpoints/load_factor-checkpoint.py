...
def show(df):
    ...
    # يمكن التعليق على عرض القيم فوق الأعمدة إذا أردت
    # for i, v in enumerate(segment_summary["load_factor"]):
    #     ax.text(i, v + max(segment_summary["load_factor"])*0.01, f"{v:.1f}%", ha='center', va='bottom', color='black', fontweight='bold')
